...
export default defineConfig({
  base: "/bigfed_lowcode_vp/",
  title: "小磊哥er的大前端低代码专题",
  description: "大前端低代码，大前端lowcode，小磊哥er的大前端低代码专题，小磊哥er的博客",
  srcDir: "./docs",
  outDir: "dist",
    head: [
    ...
    [
      "meta",
      {
        name: "keywords",
        content:
          "大前端低代码,小磊哥er的大前端低代码专题,大前端技术博客,小磊哥er,小磊哥er的博客",
      },
    ],
    ...(scripts as any[]),
  ],
  sitemap: {
    hostname: `https://www.yzsunlei.com/bigfed_lowcode_vp/`,
  },
  themeConfig: {
